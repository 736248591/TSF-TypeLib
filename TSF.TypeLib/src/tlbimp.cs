...
namespace TSF.TypeLib
{
    ...
    public interface ITfContext
    {
        ...
        [PreserveSig]
        HRESULT GetSelection([In] TfEditCookie ec, [In] TF_DEFAULT ulIndex, [In] uint ulCount, [Out, MarshalAs(UnmanagedType.LPArray)] TF_SELECTION[] pSelection, [NullAllowed] out uint pcFetched);
        [PreserveSig]
